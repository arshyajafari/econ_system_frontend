...
type NavConfig = { label: string; to: string; icon: IconName; requiredPermission?: string };
const navigation: NavConfig[] = [
  ...
  { label: "موقعیت کارکنان", to: "/employee-locations", icon: "employees", requiredPermission: "employees.view" },
...
export function DashboardLayout() {
  ...
  const closeMobileSidebar=()=>setIsSidebarOpen(false); const can=(permission:string)=>user?.roles.includes("admin")||user?.permissions.includes(permission);
