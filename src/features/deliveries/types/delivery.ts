...
export type Delivery = { id:string; order:DeliveryOrder|null; customer:DeliveryParty|null; employee:DeliveryParty|null; status:DeliveryStatus; prepared_at:string|null; shipped_at:string|null; delivered_at:string|null; cancelled_at:string|null; recipient_name:string; recipient_phone:string; province:string|null; city:string|null; address:string; description:string|null; created_at:string|null; updated_at:string|null };
export type DeliveryFormData={order_id:string;recipient_name:string;recipient_phone:string;province:string;city:string;address:string;description:string};
