...
export type VisitSample = { id: string; product?: { id: string; code?: string | null; title: string }; quantity: number };
export type Visit = { id: string; doctor: VisitDoctor | null; employee: VisitEmployee | null; visit_date: string | null; purpose: string | null; description: string | null; status: VisitStatus; samples?: VisitSample[]; created_at: string | null; updated_at: string | null };
