    ...
    <section className="space-y-6 p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-[2fr_1fr_1fr_auto]">
        <input
          ...
          placeholder="جستجو بر اساس نام، کد، موبایل یا کلینیک"
              ...
              doctors.map((doctor) => (
                <tr key={doctor.id} className="hover:bg-gray-50">
                  ...
                  <td className="whitespace-nowrap px-4 py-3 font-medium text-gray-900">
                    ...
                    {doctor.is_favorite ? (
                      <span className="mr-2" title="مورد علاقه">
                        ★
                      </span>
                    ) : null}
                  </td>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        void handleStatusChange(
                          doctor,
                          e.target.value as DoctorStatus,
                        );
                      }}
                      className="rounded-md border border-gray-300 bg-white px-2 py-1.5 text-xs disabled:opacity-60"
                    >
