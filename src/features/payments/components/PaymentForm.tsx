...
})}</select>{!payment && customerId ? <p className="mt-1.5 text-xs text-gray-500">فقط فاکتورهای صادرشده و دارای مانده این مشتری نمایش داده می‌شوند؛ فاکتور تسویه‌شده در این فهرست نمی‌آید.</p> : null}</div>
