...
export const IRANIAN_CARD_BANKS: Record<string, IranianBank> = {
  "627412": {
    ...
    logo: LOGO_BASE + "/Eghtesad_Novin.svg",
  },
  ...
  "627648": {
    ...
    logo: LOGO_BASE + "/Tosee_Saderat.svg",
  },
  "207177": {
    name: "بانک توسعه صادرات ایران",
    logo: LOGO_BASE + "/Tosee_Saderat.svg",
  ...
  "636949": {
    name: "بانک حکمت ایرانیان / سپه",
    logo: LOGO_BASE + "/Hekmat.svg",
  },
  ...
  "636795": {
    ...
    logo: LOGO_BASE + "/Bank_Markazi.svg",
  },
...
export function getIranianBankByCard(
...
export function formatCardNumber(
  ...
  return digits.replace(/\d{4}(?=\d)/g, "$&-").trim();
}
