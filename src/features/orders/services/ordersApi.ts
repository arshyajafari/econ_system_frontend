...
export async function getOrders(params: OrderListParams = {}): Promise<OrderListResponse> { const response = await apiClient.get<OrderListResponse>("/orders", { params }); return response.data; }
export async function getOrder(id: string): Promise<Order> { const response = await apiClient.get<Order>(`/orders/${id}`); return response.data; }
export async function createOrder(payload: OrderFormData): Promise<Order> { const response = await apiClient.post<Order>("/orders", normalizeOrderPayload(payload)); return response.data; }
export async function updateOrder(id: string, payload: OrderFormData): Promise<Order> { const response = await apiClient.put<Order>(`/orders/${id}`, normalizeOrderPayload(payload)); return response.data; }
export async function submitOrder(id: string): Promise<Order> { const response = await apiClient.post<Order>(`/orders/${id}/submit`); return response.data; }
export async function confirmOrder(id: string): Promise<Order> { const response = await apiClient.post<Order>(`/orders/${id}/confirm`); return response.data; }
export async function completeOrder(id: string): Promise<Order> { const response = await apiClient.post<Order>(`/orders/${id}/complete`); return response.data; }
export async function cancelOrder(id: string): Promise<Order> { const response = await apiClient.post<Order>(`/orders/${id}/cancel`); return response.data; }
export async function performOrderStatusAction(id: string, action: OrderStatusAction): Promise<Order> { switch (action) { case "submit": return submitOrder(id); case "confirm": return confirmOrder(id); case "complete": return completeOrder(id); case "cancel": return cancelOrder(id); } }
