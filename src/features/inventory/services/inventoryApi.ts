...
export async function updateInventoryBatch(id: string, data: Partial<Pick<ReceiveInventoryData, "batch_number" | "expire_date" | "quantity" | "description">>) { const response = await apiClient.put<InventoryBatch>(`/inventory-batches/${id}`, data); return response.data; }
