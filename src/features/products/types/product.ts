...
export type Product = { id: string; code: string; title: string; image: string | null; barcode: string | null; status: ProductStatus; sort_order: number; description: string | null; brand: ProductBrand | null; category: ProductCategory | null; created_at: string | null; updated_at: string | null };
...
export type ProductListResponse = { data: Product[]; links: ProductPaginationLinks; meta: ProductPaginationMeta };
export type ProductFormData = { brand_id: string; product_category_id: string; title: string; barcode: string; sort_order: number; status: ProductStatus; image: string; image_file?: File | null; description: string };
export type ProductStatusOption = { value: ProductStatus; label: string };
export const PRODUCT_STATUS_OPTIONS: ProductStatusOption[] = [
  { value: "active", label: "فعال" },
  { value: "inactive", label: "غیرفعال" },
  { value: "pending", label: "در انتظار" },
  { value: "discontinued", label: "تولید متوقف شده" },
];
