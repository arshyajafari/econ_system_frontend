...
export type ProductFormData = { brand_id: string; product_category_id: string; title: string; sale_price: string; barcode: string; sort_order: number; status: ProductStatus; image: string; image_file?: File | null; description: string };
