  ...
  return <section className="rounded-xl border border-gray-200 bg-white p-5">
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <Field label="قیمت فروش" required><input dir="ltr" type="number" min={0} step="0.01" value={form.sale_price} onChange={(event) => update("sale_price", event.target.value)} disabled={isSubmitting} className={`${inputClass} text-right`} placeholder="قیمت به ریال" /></Field>
