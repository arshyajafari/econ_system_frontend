...
export function ProductTable({ products, isLoading, pendingStatusId, pendingDeleteId, isAdmin, onEdit, onDelete, onStatusChange }: ProductTableProps) {
